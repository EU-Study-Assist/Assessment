...
const Hero = () => {
  return (
    <div className="flex justify-center text-center m-4 lg:my-10 lg:px-14 w-full lg:h-[80vh]">
      <div className="rounded border bg-primary text-white flex-1 h-80 lg:h-full flex flex-col text-center justify-center items-center">
